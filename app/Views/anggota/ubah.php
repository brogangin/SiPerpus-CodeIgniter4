    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="container mt-4">
                <form class="row g-1" action="/anggota/ubah/<?= $anggota['id_anggota'] ?>" method="post">
                    <div class="col-md-6 mt-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control <?= isset($validation['nama']) ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= $anggota['nama'] ?>">
                        <div class="invalid-feedback"><?= isset($validation['nama']) ? $validation['nama'] : ''; ?></div>
                    </div>
                    <div class="col-md-6 mt-3">
                        <label for="nik" class="form-label">NIK</label>
                        <input type="text" class="form-control <?= isset($validation['nik']) ? 'is-invalid' : ''; ?>" id="nik" name="nik" value="<?= $anggota['nik'] ?>">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <input type="text" class="form-control <?= isset($validation['alamat']) ? 'is-invalid' : ''; ?>" id="alamat" name="alamat" value="<?= $anggota['alamat'] ?>">
                        <div class="invalid-feedback"><?= isset($validation['alamat']) ? $validation['alamat'] : ''; ?></div>
                    </div>
                    <div class="col-md-6 mt-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="text" class="form-control <?= isset($validation['email']) ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= $anggota['email'] ?>">
